...
main :-
        write("Please enter all sentences with DOUBLE QUOTATION marks. Eneter in QUIT at any point, after your name, in time to exit."),nl,
        write('---------------------------------------------'), nl, 
        write('---------------------------------------------'), nl,
...
read_stmts(List) :-
        ...
        (
                ...
                (X == "movie") -> write('A good movie is Snow on da Bluff.');
